...
class App {
  ...
  //----------------------------------------------------------------------------------------------------------------toggle method-2 for elevatio vs cadence
  _toggleElevation() {
 ...
 //----------------------------------------------------------------------------------------------------------------new workout method-3 is added on submitting form
  ...
  _loadMap(position) {
    ...
    //the event listener sets the this keyword to map and the bind is used to reset it to the App clas
  }
...
const app = new App();
//here is no need to call the methods manually as they are already called inside constructor inside class App

//=====//===============================================the starter  code without using classes
// // // // // // // // // // // // // // // // // // // // //  // // // // // // // // // // // // // // // /
