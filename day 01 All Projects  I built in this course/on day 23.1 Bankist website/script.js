...
//----------------------------------------------------------implementing smooth scroll for naviggation links----
...
navParent.addEventListener("click", function (e) {
  ...
  if (btnclicked.classList.contains("nav__link")) {
    const targetId = btnclicked.getAttribute("href");
